    ...
    class NewRelicService
      ...
      def invoke_remote(method, payload = [], options = {})
        ...
        begin
          ...
          if data.present? && data.is_a?(String) && data.include?('marketing_website/index_page') && payload.present? && payload[1].present? && payload[1][0].present? && payload[1][0].respond_to?(root_node)
            timeline = []
